...
const models = [
  {
    ...
    icon: (
      <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="url(#bm1)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <defs><linearGradient id="bm1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#3b82f6" /><stop offset="100%" stopColor="#06d6a0" /></linearGradient></defs>
  ...
  },
  {
    ...
    icon: (
      <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="url(#bm2)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <defs><linearGradient id="bm2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#06d6a0" /><stop offset="100%" stopColor="#3b82f6" /></linearGradient></defs>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {models.map((item, i) => (
            ...
            >
              ...
              />
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center mb-5" style={{ background: "rgba(59,130,246,0.08)" }}>{item.icon}</div>
