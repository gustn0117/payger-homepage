        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <a href="mailto:overwrap0@gmail.com" className="flex items-center gap-3 text-text-muted hover:text-text-main transition-colors">
              ...
              <a href="tel:032-217-9500" className="flex items-center gap-3 text-text-muted hover:text-text-main transition-colors">
                <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ background: "rgba(6,214,160,0.1)", border: "1px solid rgba(6,214,160,0.2)" }}>
