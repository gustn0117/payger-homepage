      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {services.map((service, i) => (
            <div
              key={i}
              className="card-hover bg-dark-card rounded-[20px] p-10 relative overflow-hidden"
            >
              <div className="absolute top-5 right-5 text-[11px] font-bold tracking-widest text-text-muted opacity-30">
                {service.tag}
              </div>
